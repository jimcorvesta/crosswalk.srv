...
import { CrosswalkEditComponent} from './pages/crosswalk-edit/crosswalk-edit.component';
import { CrosswalkListComponent} from './pages/crosswalk-list/crosswalk-list.component';
...
const routes: Routes = [
    ...
    { path: 'crosswalks/:id',  loadChildren: './pages/crosswalk-edit/crosswalk-edit.module#CrosswalkEditModule' , canActivate: [AuthGuard] },
    { path: 'crosswalks',  loadChildren: './pages/crosswalk-list/crosswalk-list.module#CrosswalkListModule' , canActivate: [AuthGuard] },
